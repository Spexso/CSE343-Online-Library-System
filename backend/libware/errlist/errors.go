...
var (
	...
	ErrPerPageConvert    = New("err-per-page-convert", "per page variable cannot convert to string")
	ErrPageConvert       = New("err-page-convert", "page variable cannot convert to string")
)
